...
const AboutSection = () => {
  ...
  const highlights = [
    {
      ...
      title: "Clean Code",
      description:
        "Writing maintainable, efficient code that scales with modern best practices and industry standards",
      bgColor:
        "from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20",
      iconColor: "text-blue-600 dark:text-blue-400",
      borderColor: "border-blue-200 dark:border-blue-700",
      hoverBg:
        "hover:from-blue-100 hover:to-indigo-200 dark:hover:from-blue-900/30 dark:hover:to-indigo-900/30",
      stats: "500+ Functions",
      trend: "+15%",
    },
    {
      ...
      title: "Team Player",
      description:
        "Collaborating effectively in agile environments with cross-functional teams and stakeholders",
      bgColor:
        "from-emerald-50 to-teal-100 dark:from-emerald-900/20 dark:to-teal-900/20",
      iconColor: "text-emerald-600 dark:text-emerald-400",
      borderColor: "border-emerald-200 dark:border-emerald-700",
      hoverBg:
        "hover:from-emerald-100 hover:to-teal-200 dark:hover:from-emerald-900/30 dark:hover:to-teal-900/30",
      stats: "12+ Teams",
      trend: "+8%",
    },
    {
      ...
      title: "Innovation",
      description:
        "Always exploring cutting-edge technologies and creative problem-solving approaches",
      bgColor:
        "from-purple-50 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20",
      iconColor: "text-purple-600 dark:text-purple-400",
      borderColor: "border-purple-200 dark:border-purple-700",
      hoverBg:
        "hover:from-purple-100 hover:to-pink-200 dark:hover:from-purple-900/30 dark:hover:to-pink-900/30",
      stats: "25+ Ideas",
      trend: "+22%",
    },
    {
      ...
      title: "Performance",
      description:
        "Optimizing applications for lightning-fast speed and exceptional user experience",
      bgColor:
        "from-amber-50 to-orange-100 dark:from-amber-900/20 dark:to-orange-900/20",
      iconColor: "text-amber-600 dark:text-amber-400",
      borderColor: "border-amber-200 dark:border-amber-700",
      hoverBg:
        "hover:from-amber-100 hover:to-orange-200 dark:hover:from-amber-900/30 dark:hover:to-orange-900/30",
      stats: "98% Speed",
      trend: "+12%",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      company: "TechCorp",
      message:
        "Md Gulab's attention to detail and problem-solving skills are exceptional. A true professional!",
      avatar:
    ...
    },
    {
      ...
      company: "StartupXYZ",
      message:
        "Working with Gulab was amazing. His code quality and delivery speed exceeded expectations.",
      avatar:
    ...
    },
    {
      ...
      message:
        "Gulab perfectly translated our designs into beautiful, responsive web applications.",
      avatar:
  ...
  const workingHours = [
    ...
    {
      day: "Sunday",
      hours: "Available for urgent work",
      status: "emergency",
      color: "text-red-500",
    },
  ];
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-6 rounded-2xl border border-emerald-200 dark:border-emerald-700">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                Skilled in modern web technologies including React.js,
                JavaScript, HTML5, CSS3, and backend development with PHP and
                MySQL. Currently expanding my expertise in Python for AI and
                automation, always staying ahead of the technology curve.
              </p>
            </div>
                ...
                {workingHours.map((schedule, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div
                        className={`w-2 h-2 rounded-full ${schedule.color.replace(
                          "text-",
                          "bg-"
                        )}`}
                      ></div>
          ...
          <div className="space-y-4">
            {coreSkills.map((skill, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300"
                >
            ...
            {achievements.map((achievement, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <Icon
                      className={`w-8 h-8 ${achievement.color} group-hover:scale-110 transition-transform duration-300`}
                    />
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div
          className={`grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16 transition-all duration-1000 delay-300 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          ...
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
            <div className="text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2 group-hover:scale-110 transition-transform duration-300">
              {stats.experience}+
            </div>
            ...
            <div className="w-full bg-emerald-100 dark:bg-emerald-900/30 rounded-full h-1 mt-2">
              <div
                className="bg-emerald-500 h-1 rounded-full transition-all duration-1000 delay-200"
          ...
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
            ...
            <div className="w-full bg-purple-100 dark:bg-purple-900/30 rounded-full h-1 mt-2">
              <div
                className="bg-purple-500 h-1 rounded-full transition-all duration-1000 delay-400"
          ...
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
            ...
            <div className="w-full bg-orange-100 dark:bg-orange-900/30 rounded-full h-1 mt-2">
              <div
                className="bg-orange-500 h-1 rounded-full transition-all duration-1000 delay-600"
        ...
        <div className="flex flex-col xl:flex-row items-start justify-between gap-12">
          ...
          <div
            className={`xl:w-1/2 transition-all duration-1000 delay-700 ${
              isVisible
              ...
              {personalInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <Icon
                        className={`w-5 h-5 ${info.color} group-hover:scale-110 transition-transform duration-300`}
                      />
                      <div>
              ...
              {highlights.map((highlight, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div
                        className={`p-3 rounded-full bg-white/80 dark:bg-slate-800/80 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
                    ...
                    <div className="mt-4 w-full bg-white/50 dark:bg-slate-700/50 rounded-full h-1">
                      <div
                        className={`bg-gradient-to-r ${highlight.iconColor.replace(
                          "text-",
                          "from-"
                        )} to-transparent h-1 rounded-full transition-all duration-1000`}
                        style={{
                          width: activeHighlight === index ? "100%" : "60%",
                        }}
                      ></div>
                    </div>
                  </div>
          ...
          <div
            className={`xl:w-1/2 transition-all duration-1000 delay-900 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-10"
            }`}
