...
const HeroSection = () => {
  ...
  const [animatedStats, setAnimatedStats] = useState({ experience: 0, projects: 0, clients: 0 });
  ...
  const quickStats = [
    { icon: Code, label: "Projects", value: 25, suffix: "+", color: "text-blue-600 dark:text-blue-400" },
    { icon: Calendar, label: "Experience", value: 2.5, suffix: " Years", color: "text-emerald-600 dark:text-emerald-400" },
    { icon: Star, label: "GitHub Stars", value: 150, suffix: "+", color: "text-yellow-600 dark:text-yellow-400" },
    { icon: Coffee, label: "Coffee Cups", value: 999, suffix: "+", color: "text-amber-600 dark:text-amber-400" }
  ];
          ...
          <div className={`lg:w-1/2 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-lg text-slate-600 dark:text-slate-300">Currently working as</span>
              </div>
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed max-w-2xl">
              ...
              <span className="font-semibold text-purple-600 dark:text-purple-400"> functional</span> web applications 
              that solve real-world problems. Currently pursuing Computer Science Engineering with hands-on experience 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-2xl font-bold text-slate-800 dark:text-white">
                      {typeof stat.value === 'number' && stat.value < 10 ? stat.value : Math.floor(stat.value)}{stat.suffix}
                    </div>
            ...
            <div className="flex items-center space-x-6">
              <span className="text-slate-600 dark:text-slate-300 font-medium">Connect with me:</span>
