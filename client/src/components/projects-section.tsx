...
const ProjectsSection = () => {
  ...
  const [animatedStats, setAnimatedStats] = useState({ totalProjects: 0, totalStars: 0, totalViews: 0 });
  ...
  const projects = [
    {
      ...
      description: "Full-stack e-commerce solution with React, Node.js, and MongoDB featuring payment integration, admin dashboard, and real-time inventory management.",
      image: "https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
    ...
    },
    {
      ...
      description: "Collaborative task management tool with real-time updates, team collaboration features, drag-and-drop interface, and advanced analytics.",
      image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
    ...
    },
    {
      ...
      description: "Beautiful weather application with location-based forecasts, interactive maps, detailed analytics, and personalized weather alerts.",
      image: "https://images.pexels.com/photos/1118873/pexels-photo-1118873.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
    ...
    },
    {
      ...
      description: "Comprehensive social media analytics dashboard with data visualization, engagement tracking, automated reporting, and AI insights.",
      image: "https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
    ...
    },
    {
      ...
      description: "Secure mobile banking application with biometric authentication, real-time transactions, budget tracking, and investment portfolio management.",
      image: "https://images.pexels.com/photos/4386431/pexels-photo-4386431.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
    ...
    },
    {
      ...
      description: "AI-powered content generation platform with natural language processing, multiple content types, and collaborative editing features.",
      image: "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800&h=500",
        ...
        if (entry.isIntersecting) {
          ...
          const timer = setInterval(() => {
            ...
            if (currentStep >= steps) {
              clearInterval(timer);
              setAnimatedStats({ totalProjects: 25, totalStars: 951, totalViews: 18750 });
            }
          }, increment);
        }
      },
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <div className="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">{animatedStats.totalProjects}+</div>
            <div className="text-slate-600 dark:text-slate-300">Total Projects</div>
          </div>
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">{animatedStats.totalStars}+</div>
            <div className="text-slate-600 dark:text-slate-300">GitHub Stars</div>
          </div>
          <div className="text-center p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <div className="text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">{(animatedStats.totalViews / 1000).toFixed(1)}K+</div>
            <div className="text-slate-600 dark:text-slate-300">Project Views</div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-blue-600 p-8 rounded-3xl shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  <div className="text-3xl font-bold text-white">{featuredProjects.length}</div>
                  <div className="text-purple-100 text-sm">Featured</div>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {featuredProjects.slice(0, 4).map((project, index) => (
                  <div key={project.id} className="text-center p-4 bg-white/20 rounded-xl backdrop-blur-sm">
                    <div className="text-lg font-semibold text-white mb-1">{project.title}</div>
        ...
        {/* Projects Grid */}
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {filteredProjects.map((project, index) => (
            <div
              key={project.id}
              className="group bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 overflow-hidden relative"
            ...
            >
              ...
              {/* Status Badge */}
              <div className={`absolute top-4 right-4 z-20 px-3 py-1 rounded-full text-xs font-semibold ${
